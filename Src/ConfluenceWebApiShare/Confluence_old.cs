...
///// </summary>
//public sealed class Confluence_old : IDisposable
//{
...
//    public Confluence_old(string storeKey, string appName)
...
//    /// <param name="appName">The name of the application.</param>
//    public Confluence_old(Uri host, string token, string appName)
//    {
